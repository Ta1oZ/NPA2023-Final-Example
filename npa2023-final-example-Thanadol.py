#######################################################################################
# FirstName/Surname: Thanadol Phanloetrak
# Student ID: 64070156
# Github repository URL: https://github.com/Ta1oZ/NPA2023-Final-Example.git
#######################################################################################
# Instruction
...
accessToken = "Bearer NzZlYmRmOTItZTQxMi00OWI4LTlhNWEtYTUxOTI4MjczYmQxOWJhMDMxNDAtNjky_P0A1_7e57d048-2511-4d53-8dd4-05fe61659f5d" 
...
# 4. Provide the URL to the Webex Teams messages API, and extract location from the received message.
    ...
    if message.find("/Thanadol San Jose") == 0:
...
# 5. Prepare openweather Geocoding APIGetParameters..
        ...
        openweatherGeoAPIGetParameters = {
            "q": location,
            "limit": 1,
            "appid": "dc559aefe2957a288bd0794eb27a796b",
        }
